...
TASKS = [
    {
        "name": "相邻不相邻与位置限制",
        "tag": "数量关系-逢考必有的排列组合与概率-相邻不相邻与位置限制",
    ...
    {
        "name": "分堆分配与隔板模型",
        "tag": "数量关系-逢考必有的排列组合与概率-分堆分配与定序消序",
    ...
    {
        "name": "错位重排与环形圆桌",
        "tag": "数量关系-逢考必有的排列组合与概率-错位重排与环形圆桌",
    ...
    {
        "name": "古典概型与定位秒杀",
        "tag": "数量关系-逢考必有的排列组合与概率-古典概型与定位秒杀",
    ...
    {
        "name": "分步独立与赛制决胜",
        "tag": "数量关系-逢考必有的排列组合与概率-分步独立与赛制决胜",
    ...
    {
        "name": "基础计数与网格路径",
        "tag": "数量关系-逢考必有的排列组合与概率-基础原理与几何概型",
