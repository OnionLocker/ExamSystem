...
from kaodian_taxonomy import KNOWN_QUANTITY_TAGS
...
RULES: list[tuple[tuple[str, ...], str]] = [
    ...
    (("补充论据",), "判断推理-逻辑判断-补充论据"),
    (("拆桥",), "判断推理-逻辑判断-拆桥"),
    (("搭桥", "前提假设"), "判断推理-逻辑判断-搭桥"),
    (("必要条件",), "判断推理-逻辑判断-必要条件"),
    (("翻译", "逆否", "假言", "只有才", "除非"), "判断推理-逻辑判断-翻译推理"),
    (("推理形式",), "判断推理-逻辑判断-推理形式"),
    (("原因解释", "解释矛盾", "解释"), "判断推理-逻辑判断-原因解释"),
    (("论证结构", "结构相似"), "判断推理-逻辑判断-论证结构"),
    ...
    # 资料（336 没有，只用词表固定落点）
    (("直接读数", "简单查找", "简单计算", "数据检索"), "资料分析-简单计算与查找-直接查找"),
    (("基期量",), "资料分析-基期量-基期量计算"),
    (("增长量", "环比增量"), "资料分析-增长量-增长量计算与比较"),
    (("比重", "占比", "资产负债率"), "资料分析-比重-比重计算与比较"),
    (("倍数",), "资料分析-倍数-倍数计算"),
    (("综合分析", "综合判断", "综合"), "资料分析-综合分析-综合判断"),
]
...
def load_allowlist(conn: sqlite3.Connection) -> set[str]:
    allow = set(KNOWN_QUANTITY_TAGS) | set(ZILIAO_ALLOW)
