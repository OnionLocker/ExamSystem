...
> - **判断推理**：20=图形 5+逻辑 15，**不出类比/定义/科学**【GATE】；日练与科学推理拆成两套，不得把科推压进判断后 5 题。加强/削弱项必须作用于结论论证链、
>   跑题项视为缺陷；单选恰好一真（分析推理排出唯一世界）。
> - **科学推理**：独立 5 题、`category=科学推理`（**禁止** `category=判断推理`）、5 学科去重、**每题必带图**、**难度对齐广东初中档**（杠杆/浮力/串并联/海陆风/
>   等高线/食物链光合），公式限 F=ma、G=mg、p=ρgh、I=U/R 一档；**禁理想气体状态方程/动量守恒/复杂滑变/大学物理口吻**【GATE】；5 题答案任一字母 ≤2、至少 3 种字母【GATE】。
> - **言语理解**：15 题、逻辑填空 4–6（近义辨析，禁三极端假+一明显真）、其余片段阅读；禁「因此亟须」作文腔【GATE】。
> - 通用：题面禁课纲词（本题考察/秒杀模型）【GATE】；整卷答案按 answer_plan 均衡、**任一字母≤约40%**（资料仍3+1）【GATE】；不得把样卷题目写死进生成器。
    # ������ԭ��������ʱǿ�ƶ�ȡ
